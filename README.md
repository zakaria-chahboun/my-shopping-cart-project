...
** Node.js (v6.10) is a <em>server side javascript</em>

<img src='https://www.compteepargneco2.com/wp-content/uploads/2015/06/prize-node.js_.png' width='200px' alt='nodejs logo'/>

** Mongodb (v3.2.12) is a <em>NoSQL database</em>

<img alt='mongodb logo' src='http://www.lafabriquedecode.com/blog/wp-content/uploads/2013/04/mongo_logo.png' width='200px'/>

** Express.js (v4.15) is a <em>web framework for nodejs</em>

<img alt='expressjs logo' src='http://madisonabshire.com/img/tech-svg/Express.png' width='200px'/>

** MaterializeCss is a <em>modern responsive CSS framework based on Material Design by Google</em>

<img alt='MaterializeCss logo' src='http://jugid.fr/wp-content/uploads/2016/03/materialize-logo.png' width='200px'/>

** Pug (v2.0) is a <em>high performance template engine</em>
...
** ChartJS is a <em>Simple HTML5 Charts using the canvas element</em>

<img alt='chart.js logo' src='http://www.chartjs.org/img/chartjs-logo.svg' width='200px'/>


<blockquote >and more like javascript(client side), Css3..</blockquote>
<br>
<br>
<br>
** Some Screenshots **
